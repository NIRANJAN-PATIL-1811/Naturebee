  ...
  return (
    <>
      <div className="nutritious-parent-div h-full w-full mt-20 md:mb-10 md:relative md:top-10">
        ...
        <div className="child-C mt-7">
          <div className="child-C-child-A pl-5 font-extrabold md:pl-[5%] md:w-[100%] md:text-2xl md:mb-2">Suggested For You</div>

          <div className="child-C-child-B h-[30vh] mb-2 flex justify-center items-center">
            <div className="child-C-child-B-child-A h-[90%] w-[90%] flex items-center gap-2 overflow-x-scroll overflow-y-hidden md:gap- md:mb-8">
              {images1.map((item, index) =>
                index === initialVal ? null : (
                  <div key={index} onClick={() => filterFun(index)} className="nutritious-suggested-for-you-img-desc-div h-[96%] w-[40%] mb-2 flex-shrink-0 border border-[#d5d3d380] md:h-[96.5%] md:w-[10%]">
                    <div className="flex justify-center items-center h-[84%] w-[100%] md:h-[90%]">
